                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex flex-column justify-content-center">
                                            <h6 class="mb-0 text-sm">Jinco Ltd</h6>
                                        </div>
                                    </td>
                                    <td class="align-middle text-center">
                                        <a href="/master/company/edit"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex flex-column justify-content-center">
                                            <h6 class="mb-0 text-sm">Toyota</h6>
                                        </div>
                                    </td>
                                    <td class="align-middle text-center">
                                        <a href="javascript:;"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex flex-column justify-content-center">
                                            <h6 class="mb-0 text-sm">Honda Ltd</h6>
                                        </div>
                                    </td>
                                    <td class="align-middle text-center">
                                        <a href="javascript:;"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex flex-column justify-content-center">
                                            <h6 class="mb-0 text-sm">Mitsubishi Motors</h6>
                                        </div>
                                    </td>
                                    <td class="align-middle text-center">
                                        <a href="javascript:;"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex flex-column justify-content-center">
                                            <h6 class="mb-0 text-sm">Chimory Llc</h6>
                                        </div>
                                    </td>
                                    <td class="align-middle text-center">
                                        <a href="javascript:;"

<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2 my-2 bg-black" id="sidenav-main">
<div class="sidenav-header">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <ul id="user_management" class="submenu collapse  @if(!empty($subMenu) && $subMenu == 'Users Management') show @endif" data-bs-parent="#nav_accordion">
          <li class="nav-item">
            <x-sidebar-link href="/dashboard"  :active="request()->is('dashboard')">
              <span class="material-symbols-rounded opacity-5">manage_accounts</span>
        ...
        <li class="nav-item">
          <a class="nav-link text-white @if(empty($subMenu) && $subMenu != 'Course Management') collapsed @endif" data-bs-toggle="collapse" data-bs-target="#course_management" href="#">
        ...
        <ul id="course_management" class="submenu collapse @if(!empty($subMenu) && $subMenu == 'Course Management') show @endif" data-bs-parent="#nav_accordion">
          <li class="nav-item">
